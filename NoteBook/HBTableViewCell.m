...
- (void)showBottonLineWithCellHeight:(CGFloat)cellH
{
    if (self.lineView == nil) {
        self.lineView = [[UIView alloc] initWithFrame:CGRectMake(0, cellH - 0.5, 320 - 0, 0.5)];
        self.lineView.backgroundColor = [UIColor GrayLine1Color];
        [self.contentView addSubview:self.lineView];
    } else {
        self.lineView.frame = CGRectMake(0, cellH - 0.5, 320, 0.5);
    }
}
...
{
    if (self.lineView == nil) {
        self.lineView = [[UIView alloc] initWithFrame:CGRectMake(offsetX, cellH - 0.5, 320 - offsetX, 0.5)];
        self.lineView.backgroundColor = [UIColor GrayLine1Color];
        [self.contentView addSubview:self.lineView];
    } else {
...
{
    if (self.topLine == nil) {
        self.topLine = [[UIView alloc] initWithFrame:CGRectMake(offsetX, -0.5, 320 - offsetX, 0.5)];
...
{
    if (self.topLine == nil) {
        self.topLine = [[UIView alloc] initWithFrame:CGRectMake(0, -0.5, 320, 0.5)];
        self.topLine.backgroundColor = [UIColor GrayLine1Color];
        [self.contentView addSubview:self.topLine];
    }
