...
{   
    ...
    self.infoTextField = [[UITextField alloc] initWithFrame:CGRectZero];
    self.infoTextField.borderStyle = UITextBorderStyleNone;
    self.infoTextField.contentVerticalAlignment = UIControlContentVerticalAlignmentCenter;
...
- (void)configCellWithText:(NSString *)text
{
    ...
    self.infoTextField.frame = CGRectMake(80, 15, 220, 40);
